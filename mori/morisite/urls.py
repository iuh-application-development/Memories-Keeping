...
from .searchAI import SearchPhotosPublicAI, SearchPhotosForUserAI
from .views import *
...
urlpatterns = [
   ...
   # get Search_rating
   # path('search-rating/', SearchRatingView.as_view(), name='search-rating'),
   # path('search-rating/<int:pk>', SearchRatingDetailView.as_view(), name='search-ratingid'),
    
   # get filter
   # path('filter/', FilterView.as_view(), name='filter'),
   # path('filter/<int:pk>', FilterDetailView.as_view(), name='filterid'),
   ...
   # path('user/changePassWord/', UserRegistrationView.as_view(), name='register'),
   # path('user/search/', GetUserDetailView.as_view(), name='get-user-search'),   
   ...
   # path('search/filter/', SearchFilter.as_view(), name='search-filter'),
   ...
   # AI 
   # path('translate/', TranslateTextAPIView.as_view(), name='translate_text'),
